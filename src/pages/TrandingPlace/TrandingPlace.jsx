...
const TrandingPlace = () => {
  return (
    <section id='trandingplace' className='container pl-8'>
      ...
      <Link to ='/place/city'>
          <div className='flex w-[45%] border-black border-[1px] rounded-2xl m-3 p-3 shadow-lg hover:shadow-gray-400 transition duration-300'>
              <div className='w-2/3'>
      ...
      <Link to ='/place/city'>  
          <div className='flex w-[45%] border-black border-[1px] rounded-2xl m-3 ml-[55%] p-3 shadow-lg hover:shadow-gray-400 transition duration-300'>
